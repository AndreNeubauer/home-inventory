      ...
      <div className="max-w-2xl w-full mx-auto flex flex-col gap-4">
        ...
        {householdId ? (
          loading ? (
            ...
            <ShoppingList householdId={householdId} initialItems={shoppingItems} />
          )
        ) : (
          <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-4">Select an inventory to view shopping list.</div>
        )}
      </div>
    </div>
  );
